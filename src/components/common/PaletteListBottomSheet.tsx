...
export function PaletteListBottomSheet({
  ...
  const [selectedPaletteForSetting, setSelectedPaletteForSetting] =
  ...
  const handleSettingClick = (e: React.MouseEvent, palette: Palette) => {
    ...
    setSelectedPaletteForSetting(palette);
  };
  ...
  return (
    <>
      ...
      {selectedPaletteForSetting && (
        <PaletteSettingsModal
          isOpen={!!selectedPaletteForSetting}
          onClose={() => setSelectedPaletteForSetting(null)}
          palette={selectedPaletteForSetting}
        />
      )}
    </>
  );
